...
!!! info "Hopsworks installer"
    If you are performing an installation using the [Hopsworks installer script](https://docs.hopsworks.ai/3.0/setup_installation/on_prem/hopsworks_installer/), ensure that the virtual machines you install Hopsworks on are deployed in the EMR VPC.
